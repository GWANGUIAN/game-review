    ...
    <main className="mx-auto max-w-3xl space-y-8 px-4 py-10">
        ...
        <div className="mt-4 space-y-2">
          {session.session_play_blocks
            ...
            .map((b: { id: string; started_at: string; ended_at: string }) => (
              <p key={b.id} className="rounded-md border-l-2 border-primary bg-muted/50 p-3 text-sm text-foreground">
      ...
      {joined && approved ? (
        ...
        <Card className="border-dashed p-6 text-center text-sm text-muted-foreground shadow-none">
          <LockKeyhole className="mx-auto mb-2 text-primary" size={18} />
